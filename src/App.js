	...
	render() {
		...
		return (
			<div className="App">
				...
				<Switch>
					<ProtectedRoute
						path={deploymentConfig().baseUrl + "/login"}
						exact={true}
					...
					<ProtectedRoute
						path={deploymentConfig().baseUrl + "/add"}
						exact={true}
					...
					<ProtectedRoute
						path={deploymentConfig().baseUrl + "/createfood"}
						exact={true}
					...
					<ProtectedRoute
						path={deploymentConfig().baseUrl + "/plan"}
						exact={true}
						trueComponent={PlanView}
						decisionFunc={this.checkAuth.bind(this)}
					/>

					<ProtectedRoute
						path={deploymentConfig().baseUrl + "/stats"}
						exact={true}
					...
					<ProtectedRoute
						path={deploymentConfig().baseUrl + "/me"}
						exact={true}
